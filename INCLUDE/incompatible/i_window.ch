...
#xtranslate <w>. \<c\> . \<p:RTFPrint\> (\<arg1\>,\<arg2\>,\<arg3\>,\<arg4\>,\<arg5\>,\<arg6\>) => DoMethod ( <(w)>, \<"c"\> , \<"p"\> , \<arg1\> , \<arg2\> , \<arg3\> , \<arg4\> , \<arg5\> , \<arg6\> ) ;;
   ...
   ***********************************************************************
   ...
   => ;
   DECLARE WINDOW <w> ;;
   oHmgApp():APP214 := <(w)> ; #include \<<ww>.fmg\>
...
#xtranslate SET TOOLTIPSTYLE BALLOON  => oHmgApp():APP055 := .T.
#xtranslate SET TOOLTIPSTYLE STANDARD => oHmgApp():APP055 := .F.

#xtranslate SET TOOLTIPBACKCOLOR <aColor> => oHmgApp():APP056 := <aColor>
#xtranslate SET TOOLTIPFORECOLOR <aColor> => oHmgApp():APP057 := <aColor>
...
#xtranslate ToolTipMenuIsActive ()     =>   oHmgApp():APP510
...
#xtranslate ToolTipCustomDrawIsActive ()     =>   oHmgApp():APP509
...
#xtranslate SET WINDOW MAIN [ FIRST ] OFF   =>   oHmgApp():MainWindowFirst := .F.
#xtranslate SET WINDOW MAIN [ FIRST ] ON    =>   oHmgApp():MainWindowFirst := .T.
...
#command SET DEFAULT ICON TO <iconname>  =>  _oHmgApp():DefaultIconName := <iconname>
