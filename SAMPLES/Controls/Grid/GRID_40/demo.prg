...
PROCEDURE Form_ONGOTFOCUS
   ...
   nLastControlIndex := oHmgApp():LastActiveControlIndex

   DISABLE WINDOW EVENT OF Form_1
   MsgInfo ("ON GOTFOCUS: Form_1 " + ;
      IIF ( nLastControlIndex > 0," - Last Control Focused : " + ;
      ControlByIndex( nLastControlIndex ):Name, "" ) )
...
LOCAL i := oHmgApp():LastActiveFormIndex
      ...
      MsgInfo ("ON GOTFOCUS: TimePicker_1" + IIF (i > 0," - Last Form Focused : "+ FormByIndex( I ):Name,""))
