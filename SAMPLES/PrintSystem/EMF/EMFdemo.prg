...
LOCAL cNamePrefix := GetTempFolder() + oHmgApp():APP379 + "_hmg_print_preview_"
...
LOCAL Old_PageDC := OpenPrinterGetPageDC()
   ...
   @ 180, 100 PRINT " Page Number: " + hb_NtoS( nPageNumber++ ) + " of " + hb_NtoS( oHmgApp():APP380 ) FONT "Arial" SIZE 12
